...
let honeywellRapid=false;
let honeywellKeyCount=0;
...
async function iniciarLeitorNativo(
    video
){
...
function processarCodigo(
    ...
    if(
        ...
        // Para somente a câmera.
        // O Honeywell também fica
        // bloqueado enquanto informa
        // a quantidade.
